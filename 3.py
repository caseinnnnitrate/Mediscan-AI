...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "MEDISCAN AI App"))
    ...
    def predict_result(self):
        if result[0][0] > 0.5:
            diagnosis = "Result is Normal"
        else:
            diagnosis = "Affected By PNEUMONIA"
        
        # Show the result on the label_2
        self.label_2.setText(diagnosis)
